...
public class DoneAdapter extends BaseAdapter{
    ...
    public DoneAdapter(List<TodoInfo> lists, Context context) {
        this.lists = lists;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        layout = (LinearLayout) inflater.inflate(R.layout.cell_done,null);
        thing = layout.findViewById(R.id.done_listview_tv);
        time = layout.findViewById(R.id.done_finishTime_lv);
